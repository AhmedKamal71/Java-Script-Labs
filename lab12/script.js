// 1)
const obj1 = {name:"ahmed",birth:2001}
const obj2 = {name:"ahmed",birth:2001}

function CheckPropertyValue(obj1,obj2){
...
// Another Way
let check = (obj1,obj2)=> Object.keys(obj1).every(key => obj2.hasOwnProperty(key) && obj1[key] === obj2[key])
// ---------------------------------------------------------------------------------------------------------
// 2)
...
function csvToArray(csvString) {
    let rowsArr = csvString.split('\n')
    let TwoDarray = [];
    for(let key of rowsArr){
        let wordsArr = key.split(',')
        TwoDarray.push(wordsArr)
    }
    return TwoDarray;
}
// ---------------------------------------------------------------------------------------------------------
...
const stringToObject = (str) => {
    ...
    const keysArr = lines[0].split(',');

    const objArr = lines.slice(1).map((line) => {
        const values = line.split(',');
        return keysArr.reduce((obj, key, index) => {
...
function objectsToCSV(data, columns) {
    ...
    const csvLines = filteredData.map(obj =>
...
function ConvertDigits(num){
    ...
    let arr = str.split('').map((para)=> +para)
    return arr
}
// ---------------------------------------------------------------------------------------------------------
// 8)
function filterArray(arr,filter){
    newArr = arr.filter((ele)=> !filter.includes(ele))
    return newArr
}
// ---------------------------------------------------------------------------------------------------------
// 9)
function getAllCombinations(inputArray) {
    ...
    for (let num of inputArray) {
        let currentCombinations = [...result];
...
function ExtractElement(arr, indexesArr) {
    let Arr = indexesArr.map((index) => arr[index]);
    console.log(Arr);
}
// ---------------------------------------------------------------------------------------------------------
// 11)
...
// ---------------------------------------------------------------------------------------------------------
// 12)
const ASCII = str => str.replace(/[^\x20-\x7E]/g, '');
// ---------------------------------------------------------------------------------------------------------
// 13)
...
function Check(arr1,arr2){
    ...
    for(let i =0; i < arr1.length; i++){
        ((arr1[i] && arr2[i]) == true)? Arr1.push(arr1[i]) : Arr2.push(arr1[i])
    }
    console.log(`First Group Is: ${Arr1}`)
    console.log(`Second Group Is: ${Arr2}`)
}
// ---------------------------------------------------------------------------------------------------------
// 18)
let RemoveLeftElelment = (arr,ele)=> arr.slice(ele)
// ---------------------------------------------------------------------------------------------------------
// 19)
let RemoveRightElelment = (arr,ele)=> arr.slice(-ele)
// ---------------------------------------------------------------------------------------------------------
// 20)
const extend_Hex = shortHex =>'#' + shortHex.slice(shortHex.startsWith('#') ? 1 : 0).split('').map(x => x + x).join('');
// ---------------------------------------------------------------------------------------------------------
// 21)
let x = (arr, search) => {
  let ele = arr.filter((index) => {
    return index == arr[search];
  });
  return ele;
};
console.log(x([1, 2, 3, 5], 3));
// ---------------------------------------------------------------------------------------------------------
// 22)
